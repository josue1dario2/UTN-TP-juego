...
void Hud::dibujar(sf::RenderWindow& ventana) {
    ...
    if (juegoTerminado) {
        ...
        textoVida.setPosition(35.f, height - 130.f);
        fondoBarraVida.setPosition(35.f, height - 110.f);
        barraVida.setPosition(35.f, height - 110.f);

        textoArmadura.setPosition(35.f, height - 90.f);
        fondoBarraArmadura.setPosition(35.f, height - 70.f);
        barraArmadura.setPosition(35.f, height - 70.f);

        textoHabilidad.setPosition(35.f, height - 50.f);
        fondoBarraHabilidad.setPosition(35.f, height - 30.f);
        barraHabilidad.setPosition(35.f, height - 30.f);
