...
void Arma::disparar(sf::Vector2f origen, sf::Vector2f destino, const sf::Image& mapaColision) {
...
void Arma::actualizar(float deltaTime, const sf::Image& mapaColision) {
    for (size_t i = 0; i < proyectiles.size(); ) {
        ...
        proyectiles[i].verificarColisiones(mapaColision);
